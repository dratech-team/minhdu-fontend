...
export class CommodityTemplateService extends BaseService<CommodityTemplateEntity> {
  ...
  addOne(
    addBranchDto: AddCommodityTemplateDto
  ): Observable<CommodityTemplateEntity> {
    return super.addOne(addBranchDto.body);
  }

  pagination(
    props: Partial<SearchCommodityTemplateDto>
  ): Observable<ResponsePaginate<CommodityTemplateEntity>> {
  ...
  getOne(
    loadOneDto: LoadOneCommodityTemplateDto
  ): Observable<CommodityTemplateEntity> {
    return super.getOne(loadOneDto.id);
  }

  update(
    updateBranchDto: UpdateCommodityTemplateDto
  ): Observable<CommodityTemplateEntity> {
