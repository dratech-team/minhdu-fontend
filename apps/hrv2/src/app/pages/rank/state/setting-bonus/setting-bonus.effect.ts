...
export class SettingBonusEffect {
      ...
      Object.assign(props.search,
        {
          ...
          skip: props.isPaginate ? this.settingBonusQuery.getCount() : PaginationDto.skip
        }
      )
      return this.settingBonusService.pagination(props).pipe(
        map((res) => {
          this.settingBonusStore.update(state => (  Object.assign({
  ...
  loadOne$ = this.action$.pipe(
    ...
    switchMap((props) => this.settingBonusService.getOne(props).pipe(
