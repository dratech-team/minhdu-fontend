...
const addOne = createAction('[CONTRACT] Add One', props<AddContractDto>());

//Chưa sử dụng, sử dụng khi tạo module quản lý hợp đồng nhân viên
const loadAll = createAction('[CONTRACT] Load All', props<SearchContractDto>());
...
const update = createAction('[CONTRACT] Update', props<UpdateContractDto>());

const remove = createAction('[CONTRACT] Remove', props<RemoveContractDto>());
