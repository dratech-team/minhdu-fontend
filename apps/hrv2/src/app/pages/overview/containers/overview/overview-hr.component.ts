...
export class OverviewHrComponent {
  overviewAgeEmployee$ = this.overviewService.overviewAge({
    filter: OverviewFilterEnum.AGE,
  });
  overviewTotalEmployee$ = this.overviewService.overviewTotalEmp({
    filter: OverviewFilterEnum.CREATED_AT,
  });
