...
import { Branch } from './../../../../../../../../libs/data-models/hr/orgChart/branch';
...
export class PayrollAbsentComponent implements OnInit {
  ...
  ngOnInit() {
    let paramLoadInit = {
      ...
      position: getState<string>(selectedPositionPayroll, this.store),
      branch: getState<string>(selectedBranchPayroll, this.store),
    };
