  ...
  confirmPayroll(reconfirm: boolean): any {
    if (this.currentUser?.role?.role === Role.HUMAN_RESOURCE) {
      ...
      return this.message.warning(
        'Quản lý nhân sự không được phép xác nhận phiếu lương'
      );
    }
        ...
        this.dialog
          .open(DialogSharedComponent, {
            ...
            data: {
              ...
              description:
                'Việc Xác nhận phiếu lương sẽ làm đóng băng các thao tác trên phiếu lương, bạn có chắc chắn muốn xác nhận',
            },
          })
          .afterClosed()
          .subscribe((val) => {
