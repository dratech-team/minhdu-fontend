...
export  const adapterProvince: EntityAdapter<Province> = createEntityAdapter<Province>();
export const initialProvince = adapterProvince.getInitialState({ loaded: false, })
