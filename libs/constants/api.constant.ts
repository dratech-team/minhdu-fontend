export const Api = {
  ...
  SELL: {
    ...
    STATISTICAL: {
      ...
      STATISTICAL_PROVINCE: 'overview/nation',
      STATISTICAL_CHICKEN: 'overview/chicken',
      STATISTICAL_CUSTOMER: 'overview/customer',
      STATISTICAL_AGENCY_PRINT: 'overview/agency/export/print',
      STATISTICAL_PROVINCE_PRINT: 'overview/nation/export/print',
      STATISTICAL_CHICKEN_PRINT: 'overview/chicken/export/print',
      STATISTICAL_CUSTOMER_PRINT: 'overview/customer/export/print',
    },
    CUSTOMER: {
      CUSTOMER: 'customer',
